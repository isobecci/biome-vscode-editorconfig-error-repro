Added .editorconfig and migrated the biome to 1.9.4. `insert_final_newline = false` in .editorconfig is causing problems with biome-vscode.

----

original: https://github.com/ivesfurtado/next-express-biome-turborepo  
original README:
